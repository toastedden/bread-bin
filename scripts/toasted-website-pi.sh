...
# Clone second repository, build with Docker Compose, then return to home directory
echo "!- INSTALL TOASTED DEN WEBSITE -!"
...
sudo ufw allow 2712 # Website
sudo ufw allow 3000 # Site JS Server
sudo ufw delete 6 -y
sudo ufw delete 6 -y
sudo ufw delete 6 -y
sudo ufw delete 6 -y
